...
if __name__ == "__main__":
    # Test the visualizer
    import sys
    sys.path.insert(0, '/Users/kalaimaranbalasothy/GitHub Projects/CyberCouncil')
    ...
    # Create test graph
    graph = AttackGraph("test_visualization")
    ...
    graph.add_node("CRED_1234", node_type="CREDENTIAL", cred_type="password")
    ...
    graph.add_edge("administrator", "CRED_1234", relationship="has_credential")
